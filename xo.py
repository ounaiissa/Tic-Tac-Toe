...
def play():
    ...
    head = Button(menu, text="---Welcome to tic-tac-toe---",
                  ...
                  activebackground="black", bg="gray",
    ...
    B2 = Button(menu, text="Multi Player", command=wpl, activeforeground='gray',
                activebackground="black", bg="gray", fg="black",
                width=500, font='summer', bd=5)

    B3 = Button(menu, text="Exit", command=menu.quit, activeforeground='gray',
                activebackground="black", bg="gray", fg="black",
                width=500, font='summer', bd=5)
    head.pack(side='top')
    B1.pack(side='top')
